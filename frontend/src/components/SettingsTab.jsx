    ...
    >
      <div style={cardShellStyle}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              <div
                style={{ fontSize: "14px", fontWeight: 600, color: "#fafafa" }}
              >
                {githubUser || "Developer"}
              </div>
              <div
                style={{ fontSize: "12px", color: "#52525b", fontFamily: MONO }}
              >
      ...
      >
        ...
        >
          ...
          >
            Permanently delete your VeloCore account, including all deployment
            records and stored GitHub credentials. This cannot be undone.
          </p>
          <button
