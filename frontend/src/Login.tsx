...
function StackIcon({ name, slug, size = 32 }) {
  ...
  return (
    <div style={s.stackBadge}>
      {failed ? (
        <span style={s.stackFallbackText}>
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.hero}>
        ...
        <div
          style={{ ...s.right, animation: "fadeSlideUp 0.7s ease 0.15s both" }}
        >
                    ...
                    <div
                      style={{
                        ...
                        background: isActive
                          ...
                          : "#0c0c0d",
                        boxShadow: isActive
                          ? "0 0 0 1px rgba(62,207,142,0.18), 0 10px 26px -10px rgba(62,207,142,0.4)"
                          : "none",
                      }}
                    >
                      <span
...
const s = {
  ...
  bgVignette: {
    ...
    pointerEvents: "none",
    background:
      "radial-gradient(ellipse 90% 60% at 50% 0%, transparent 40%, #050506 100%)",
  },
  ...
  diagramGlow: {
    ...
    borderRadius: "50%",
    background:
      "radial-gradient(circle, rgba(62,207,142,0.14) 0%, transparent 70%)",
    pointerEvents: "none",
  },
  diagramHead: {
    display: "flex",
  ...
  scanLine: {
    ...
    width: "35%",
    background:
      "linear-gradient(90deg, transparent, rgba(62,207,142,0.09), transparent)",
  ...
  connectorPacket: {
    ...
    borderRadius: "50%",
    background: "#c9ffe6",
    boxShadow: "0 0 6px 2px rgba(62,207,142,0.7)",
  ...
  stackTopLine: {
    ...
    height: 1,
    background:
      "linear-gradient(90deg, transparent, rgba(62,207,142,0.6), transparent)",
  },
